 ...
 * classpath when present, otherwise falls back to local development defaults
 * ({@code http://localhost:5503}, matching the connector-toolkit compose
 * stack). Env vars override either source: {@code FLOW_ENGINE_URL},
