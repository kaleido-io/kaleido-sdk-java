...
/**
 * Marks a bean as a Kaleido event processor with the given name.
 *
 * <p>The annotated class must implement
 * {@link io.kaleido.wfe.sdk.handlers.EventProcessor}. The {@link #value()}
...
@Documented
@Component
public @interface KaleidoEventProcessor {
